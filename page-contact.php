            ...
            <div class="contacts__wrapper">
                ...
                <div class="contacts__right">
                    <div class="contacts__items">
                        ...
                        <div class="contacts__items_phone">
                        ...
                        <div class="contacts__items_mail">
                    ...
                    <div class="contacts__social">
                        ...
                        <a href="<?php the_field ('linkedin'); ?>" class="contacts__social_link">
                            <img src="<?php echo bloginfo ('template_url');?>/assets/img/icons/social/contacts_link.svg" alt="linkedin"></a>
                    </div>
                </div>
            </div>
        </div>
